          ...
          <tbody>
            {collectedCAMs?.map((study, index) => (
              ...
              >
                ...
                <Link
                       href={"https://camgalaxy.github.io/?ShowResearcherButtons=true&link=https://camadministrative.vercel.app/api/drawstudy?study=" + params.id + "&participantID=" + study.camid}
                      target="_blank"
